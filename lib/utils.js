...
exports.isProd = function(app) {
  let isProd = function(app) { return app.config.env !== 'local' && app.config.env !== 'unittest'; };

  if (app.config.onerror && (typeof app.config.onerror.isProd === 'function')) {
    isProd = app.config.onerror.isProd;
  }
